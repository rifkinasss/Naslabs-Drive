...
const extensionGroups = [
  { label: 'Images', values: ['jpg', 'jpeg', 'png', 'webp', 'gif', 'svg'] },
        ...
        <div className="w-full space-y-6">
          ...
          <Section title="File policy" description="Select the file types users are allowed to upload.">
            <div className="space-y-5">
              <div className="flex flex-wrap items-center gap-2 rounded-xl border border-border/80 bg-muted/20 p-3"><span className="mr-1 text-xs font-semibold text-muted-foreground">Presets:</span><Button type="button" variant="outline" size="sm" onClick={() => applyPreset(['jpg', 'jpeg', 'png', 'webp', 'gif', 'pdf', 'txt'])}>Basic</Button><Button type="button" variant="outline" size="sm" onClick={() => applyPreset(['jpg', 'jpeg', 'png', 'webp', 'gif', 'svg', 'pdf', 'txt', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'csv'])}>Office</Button><Button type="button" variant="outline" size="sm" onClick={() => applyPreset(extensionGroups.flatMap(group => group.values))}>All supported</Button><span className="ml-auto text-xs text-muted-foreground">{selectedExtensions.size} selected</span></div>
